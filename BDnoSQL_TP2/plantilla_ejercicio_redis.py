...
# ========================
# todos los pares id, nombre para los deportistas con id 10, 20 y 30. 
# El ejercicio debe resolverse como si se fuesen a listar TODOS los id existentes, pero al momento de listar sólo se
#deben listar los indicados.
# ========================
...
def generar_reporte(db):
    ...
    for clave in claves:
        ...
        if id_deportista in ["10", "20", "30"]:
            nombre_deportista = db.get(clave)
            linea = id_deportista + "," + nombre_deportista
            grabar_linea(archivo, linea)

    # for clave in [10,20,30]:
    #         nombre_deportista = db.hget(clave, "nombre_deportista")
    #         linea = f"{clave},{nombre_deportista}"
    #         grabar_linea(archivo, linea)
