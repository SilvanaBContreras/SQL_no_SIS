...
def generar_reporte(database):
    ...
    grabar_linea(
        archivo,   "Podio por especialidad en cada torneo:"
    )
    grabar_linea(
        archivo,
    ...
    grabar_linea(
        archivo,
        "Especialidad,Torneo,Deportista,Marca"
    )
    database.sort()
    ...
    for resultado in database:
        ...
        torneo = resultado[1]
        deportista = resultado[3]

        if especialidad != especialidad_anterior or torneo != torneo_anterior:
            especialidad_anterior = especialidad
            torneo_anterior = torneo
            deportistas_podio = []
